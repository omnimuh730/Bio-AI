...
import 'settings_input_field.dart';
import 'settings_section_label.dart';
import 'settings_selectable_chip.dart';
          ...
          children: [
            Padding(
              ...
              child: Wrap(
                ...
                runSpacing: 10,
                children: chips
                    .map((chip) => SettingsSelectableChip(
                          label: chip,
            ...
            const Padding(
              ...
              child: Column(
                children: [
                  SettingsInputField(label: 'Allergies', hint: 'Peanuts, Gluten, Dairy'),
                  SizedBox(height: 12),
